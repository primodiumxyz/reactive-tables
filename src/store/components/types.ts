...
export type Component = BaseComponent<Schema, StoreConfig> & ExtendedComponentMethods<Schema>;

export type BaseComponent<S extends Schema, config extends StoreConfig> = {
  schema: S;
  metadata: {
    id: string;
