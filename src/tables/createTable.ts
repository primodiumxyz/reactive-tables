 ...
 * @param keySchema Optional {@link Schema}, same structure as above, for keys.
...
export function createTable<PS extends Schema, M extends BaseTableMetadata, T = unknown>(
  ...
  const $records = () =>
    transformIterator((Object.values(properties)[0] as Map<$RecordSymbol, unknown>).keys(), get$RecordHex);
