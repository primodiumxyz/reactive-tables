...
library Inventory {
    ...
    function decodeDynamic(EncodedLengths _encodedLengths, bytes memory _blob)
        internal
        pure
        returns (uint32[] memory items, uint32[] memory weights)
    {
        uint256 _start;
        uint256 _end;
        unchecked {
    ...
    function decode(bytes memory _staticData, EncodedLengths _encodedLengths, bytes memory _dynamicData)
        internal
        pure
        returns (InventoryData memory _table)
    {
     ...
     */
    function encodeLengths(uint32[] memory items, uint32[] memory weights)
        internal
        pure
    ...
    /**
     * @notice Encode all of an entity's fields.
     * @return The static (fixed length) data, encoded into a sequence of bytes.
     * @return The lengths of the dynamic fields (packed into a single bytes32 value).
     * @return The dynamic (variable length) data, encoded into a sequence of bytes.
     */
    function encode(uint256 totalWeight, uint32[] memory items, uint32[] memory weights)
        internal
        pure
